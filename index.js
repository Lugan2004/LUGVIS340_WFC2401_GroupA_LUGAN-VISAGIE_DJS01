...
const IntialAmountOfFuel = 5000; // remaining fuel (kg)
const fuelBurnRate = 0.5; // fuel burn rate (kg/s)


const newDistance = d + (vel*time) //calcultes new distance
...
calcNewVel = (velocityInKmh, spacecraftAcceleration, timeInSeconds) => { 
